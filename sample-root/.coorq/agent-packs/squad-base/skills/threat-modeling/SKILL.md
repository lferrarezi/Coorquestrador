...
## Objetivo
Fornecer uma capacidade reutilizavel para `threat-modeling` dentro da AI Delivery Squad.

## Quando usar
- Quando o agente precisar executar `threat-modeling` com padrao consistente.
