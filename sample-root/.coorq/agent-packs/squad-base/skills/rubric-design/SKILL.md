...
## Objetivo
Fornecer uma capacidade reutilizavel para `rubric-design` dentro da AI Delivery Squad.

## Quando usar
- Quando o agente precisar executar `rubric-design` com padrao consistente.
