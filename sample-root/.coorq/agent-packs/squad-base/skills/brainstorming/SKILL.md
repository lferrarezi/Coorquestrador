...
## Objetivo
Fornecer uma capacidade reutilizavel para `brainstorming` dentro da AI Delivery Squad.

## Quando usar
- Quando o agente precisar executar `brainstorming` com padrao consistente.
