# Skill: Squad Optimization

## Objetivo
Fornecer uma capacidade reutilizavel para `squad-optimization` dentro da AI Delivery Squad.

## Quando usar
- Quando o agente precisar executar `squad-optimization` com padrao consistente.
