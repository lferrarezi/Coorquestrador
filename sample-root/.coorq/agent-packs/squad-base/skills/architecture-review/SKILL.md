...
## Objetivo
Fornecer uma capacidade reutilizavel para `architecture-review` dentro da AI Delivery Squad.

## Quando usar
- Quando o agente precisar executar `architecture-review` com padrao consistente.
