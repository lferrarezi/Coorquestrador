...
## Objetivo
Fornecer uma capacidade reutilizavel para `executive-writing` dentro da AI Delivery Squad.

## Quando usar
- Quando o agente precisar executar `executive-writing` com padrao consistente.
