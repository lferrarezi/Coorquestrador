...
## Objetivo
Fornecer uma capacidade reutilizavel para `homologation` dentro da AI Delivery Squad.

## Quando usar
- Quando o agente precisar executar `homologation` com padrao consistente.
