# Skill: Backlog Generation

## Objetivo
Fornecer uma capacidade reutilizavel para `backlog-generation` dentro da AI Delivery Squad.

## Quando usar
- Quando o agente precisar executar `backlog-generation` com padrao consistente.
