...
## Objetivo
Fornecer uma capacidade reutilizavel para `constitution` dentro da AI Delivery Squad.

## Quando usar
- Quando o agente precisar executar `constitution` com padrao consistente.
