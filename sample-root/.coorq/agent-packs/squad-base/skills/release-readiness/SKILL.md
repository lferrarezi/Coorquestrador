...
## Objetivo
Fornecer uma capacidade reutilizavel para `release-readiness` dentro da AI Delivery Squad.

## Quando usar
- Quando o agente precisar executar `release-readiness` com padrao consistente.
