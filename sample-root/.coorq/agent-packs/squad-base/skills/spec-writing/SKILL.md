...
## Objetivo
Fornecer uma capacidade reutilizavel para `spec-writing` dentro da AI Delivery Squad.

## Quando usar
- Quando o agente precisar executar `spec-writing` com padrao consistente.
