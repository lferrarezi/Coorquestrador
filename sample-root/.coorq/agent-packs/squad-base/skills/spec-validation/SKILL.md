...
## Objetivo
Fornecer uma capacidade reutilizavel para `spec-validation` dentro da AI Delivery Squad.

## Quando usar
- Quando o agente precisar executar `spec-validation` com padrao consistente.
