...
## Objetivo
Fornecer uma capacidade reutilizavel para `plan-validation` dentro da AI Delivery Squad.

## Quando usar
- Quando o agente precisar executar `plan-validation` com padrao consistente.
