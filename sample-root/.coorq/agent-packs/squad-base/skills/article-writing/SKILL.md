...
## Objetivo
Fornecer uma capacidade reutilizavel para `article-writing` dentro da AI Delivery Squad.

## Quando usar
- Quando o agente precisar executar `article-writing` com padrao consistente.
