...
## Objetivo
Fornecer uma capacidade reutilizavel para `agent-design` dentro da AI Delivery Squad.

## Quando usar
- Quando o agente precisar executar `agent-design` com padrao consistente.
