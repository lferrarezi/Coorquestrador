...
## Objetivo
Fornecer uma capacidade reutilizavel para `decision-log` dentro da AI Delivery Squad.

## Quando usar
- Quando o agente precisar executar `decision-log` com padrao consistente.
