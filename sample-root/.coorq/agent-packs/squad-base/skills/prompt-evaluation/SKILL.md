...
## Objetivo
Fornecer uma capacidade reutilizavel para `prompt-evaluation` dentro da AI Delivery Squad.

## Quando usar
- Quando o agente precisar executar `prompt-evaluation` com padrao consistente.
