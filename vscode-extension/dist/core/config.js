...
class CoorqConfig {
    ...
    loadEngines() {
        const enginesFile = readYaml(this.enginesPath());
        ...
        if (gemini) {
            ...
            if (gemini.models.length === 0)
                gemini.models = ["gemini-2.5-pro", "gemini-2.5-flash"];
            if (!gemini.models.includes(gemini.default_model))
                gemini.default_model = gemini.models[0];
        }
        return enginesFile;
    }
